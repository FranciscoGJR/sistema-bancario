...
/**
 * Interface que define a camada de acesso a dados para a entidade Curso. Esta
 * interface estende JpaRepository, fornecendo acesso a operações de CRUD
 * (Create, Read, Update, Delete) para a entidade Curso.
 */
@Repository
public interface CursoRepository extends JpaRepository<Curso, Integer> {
	 ...
	 * @return Uma lista contendo os cursos encontrados com base no nome completo
	 *         informado.
	 */
	 ...
	 * @return Uma lista contendo os cursos cujos nomes contêm a sequência de
	 *         caracteres informada.
	 */
	List<Curso> findCursoByNomeContaining(String valor);

	/**
	 * Busca cursos cujo nome corresponda, ignorando maiúsculas e minúsculas, à
	 * sequência de caracteres informada.
	 *
	 * @param valor A sequência de caracteres a ser buscada no nome dos cursos, sem
	 *              distinção entre maiúsculas e minúsculas.
	 * @return Uma lista contendo os cursos cujos nomes correspondem à sequência de
	 *         caracteres informada, ignorando maiúsculas e minúsculas.
	 */
